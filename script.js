const datasets = [
  {
    name: "SynHAT Synthetic Human Activity Traces",
    description: "Synthetic human activity traces generated by a coarse-to-fine diffusion framework and evaluated across four cities in three countries.",
    type: "trajectory",
